...
# COMMENTED OUT FOR DEPLOYMENT - UNCOMMENT WHEN READY
...
# For deployment, set model to None
model = None
...
def index():
    if request.method == "POST":
        # COMMENTED OUT FOR DEPLOYMENT - SHOW MESSAGE INSTEAD
        flash("Audio upload functionality is temporarily disabled for deployment. Coming soon!", "info")
